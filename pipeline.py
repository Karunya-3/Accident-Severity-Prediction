...
if st.sidebar.button('Predict'):
    ...
    if predicted_class[0] == 2:
        st.markdown("<h1 style='font-size: 40px; font-weight: bold;'>Predicted Injury: Slight Injury</h1>", unsafe_allow_html=True)
    elif predicted_class[0] == 1:
        st.markdown("<h1 style='font-size: 40px; font-weight: bold;'>Predicted Injury: Serious Injury</h1>", unsafe_allow_html=True)
    else:
        st.markdown("<h1 style='font-size: 40px; font-weight: bold;'>Predicted Injury: Fatal Injury</h1>", unsafe_allow_html=True)